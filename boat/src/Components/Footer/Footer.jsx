    ...
    <Foot>
      ...
      <Text>
        <p>
          ...
          home audio. <br /> From workouts to adventures, boAt will get you
          sailing!
        </p>
      </Text>
      <Bottom>
        <div className="container">
          <div>
            ...
            <div className="text-input">
              <div>
                Subscribe to email alerts. We promise not to spam your <br />
                inbox.
              </div>
              <div>
            ...
            <div className="socilalogos">
              <div>
                {" "}
                <img src={facebook} width="23px" height="23px" alt="" />{" "}
              </div>
              <div>
                {" "}
                <img src={twitter} width="23px" height="23px" alt="" />{" "}
              </div>
              <div>
                {" "}
                <img src={instagram} width="23px" height="23px" alt="" />{" "}
              </div>
              <div>
                {" "}
                <img src={youtube} width="23px" height="23px" alt="" />{" "}
              </div>
              <div>
                {" "}
                <img src={linkedin} width="23px" height="23px" alt="" />{" "}
              </div>
            </div>
          </div>
          <div className="links">
